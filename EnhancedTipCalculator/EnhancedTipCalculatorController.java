// EnhancedTipCalculatorController.java
...
public class EnhancedTipCalculatorController {
   ...
   @FXML 
   private TextField individualTotalTextField;
   ...
   private void calculateButtonPressed(ActionEvent event) 
   {
      try 
      {
         ...
         BigDecimal individualTotal = amount.divide(partySize);
         BigDecimal total = amount.add(tip);
         
         tipTextField.setText(currency.format(tip));
         individualTotalTextField.setText(currency.format(individualTotal));
      ...
      {
         partySizeTextField.setText("Enter party size");
         partySizeTextField.selectAll();
         partySizeTextField.requestFocus();
      }
   }
